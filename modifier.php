...
if(isset($_POST['id_entite'])){
$aid2 ='SELECT * FROM entite WHERE id_entite = "'.$_POST['id_entite'].'"';
$req=mysql_query($sql);
$dataent= mysql_fetch_array($req);}

//**************************************************************************************************************************

 if ( isset($_GET['id_equipement'], $_GET['id_equipement']) ) {
  $id=$_GET["id_equipement"];
  $sql="SELECT *FROM entite,interlocuteur,equipement,responsable_maintenance WHERE id_equipement=$id";
...
if(isset($_POST["modifier"])){
	...
	$sigle=$_POST["sigle"];
	$tel=$_POST["tel"];
$sql="UPDATE entite SET type_entite='{type_entite}', libelle='{libelle}',sigle='{sigle}',tel='{tel}' WHERE id_equipement=$id";

$id_interlocuteur=$_POST["id_interlocuteur"];
$Nom=$_POST["Nom"];
$PreNom=$_POST["PreNom"];
$Tel=$_POST["Tel"];
$sql="UPDATE interlocuteur SET  id_interlocuteur='{id_interlocuteur}',Nom='{Nom}',PreNom='{preNom}',Tel='{Tel}' WHERE id_equipement=$id";
...
$sql="UPDATE maintenance SET  id_maintenance='{id_maintenance}',date_entree='{date_entree}',description_incident='{description_incident}',date_sortie='{date_sortie}',est_repare='{est_repare}' WHERE id_equipement=$id";
...
$Modele=$_POST["Modele"];
$Marque=$_POST["Marque"];
$sql="UPDATE equipement SET type_equipement='{type_equipement}',id_equipement='{id_equipement}',Modele='{Modele}',Marque='{Marque}' WHERE id_equipement=$id";
$id_resp=$_POST["id_resp"];
$Nom=$_POST["Nom"];
$preNom=$_POST["preNom"];
$tel=$_POST["tel"];
$sql=" UPDATE responsable_maintenance SET id_resp='{id_resp}',Nom='{Nom}',preNom='{preNom}',tel='{tel}'WHERE id_equipement=$id";
...
<li><a href="login.php"></i>Déconnexion</a></li>
       ...
       <form action="modifier.php" method="POST">
        <h1>La modificationn de l'equipement</h1>
